from pynput import keyboard #Installer la bibliotheque pynput
import pygame #Installer la bibliotheque pygame
import time
from jeu import Jeu
...
#initialisation du mixer et de sound pour faire les pas des joueurs et on baisse le volume
mixer.init()
s = mixer.Sound("sfx_step_grass_l.mp3")    
s.set_volume(0.1)
...
#Le listener lis l'interraction des touches tant que le programme n'est pas terminé
